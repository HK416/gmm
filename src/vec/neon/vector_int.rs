...
impl From<Vector> for VectorInt {
    ...
    fn from(value: Vector) -> Self {
        unsafe { VectorInt(vreinterpretq_s32_f32(*value)) }
    }
}
...
impl From<Integer4> for VectorInt {
    ...
    fn from(value: Integer4) -> Self {
        unsafe { VectorInt(vld1q_s32(&value as *const _ as *const i32)) }
    }
}
...
impl Into<Integer4> for VectorInt {
    ...
    fn into(self) -> Integer4 {
        ...
        unsafe { vst1q_s32(&mut result as *mut _ as *mut i32, *self) };
        return result;
    }
}
...
impl ops::Add<Self> for VectorInt {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(vaddq_s32(*self, *rhs)) }
    }
}
...
impl ops::Sub<Self> for VectorInt {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(vsubq_s32(*self, *rhs)) }
    }
}
...
impl ops::Neg for VectorInt {
    ...
    fn neg(self) -> Self::Output {
        unsafe { VectorInt(vnegq_s32(*self)) }
    }
}
...
impl ops::Mul<Self> for VectorInt {
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(vmulq_s32(*self, *rhs)) }
    }
}
...
impl ops::BitAnd<Self> for VectorInt {
    ...
    fn bitand(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(vandq_s32(*self, *rhs)) }
    }
}
...
impl ops::BitOr<Self> for VectorInt {
    ...
    fn bitor(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(vorrq_s32(*self, *rhs)) }
    }
}
...
impl ops::BitXor<Self> for VectorInt {
    ...
    fn bitxor(self, rhs: Self) -> Self::Output {
        unsafe { VectorInt(veorq_s32(*self, *rhs)) }
    }
}
...
impl ops::Not for VectorInt {
    ...
    fn not(self) -> Self::Output {
        unsafe { VectorInt(vmvnq_s32(*self)) }
    }
}
